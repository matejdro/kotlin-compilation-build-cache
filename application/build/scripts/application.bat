...
set CLASSPATH=%APP_HOME%\lib\application.jar;%APP_HOME%\lib\utilities.jar;%APP_HOME%\lib\list.jar


@rem Execute application
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %APPLICATION_OPTS%  -classpath "%CLASSPATH%" org.gradle.sample.app.Main %*
